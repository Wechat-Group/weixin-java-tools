...
public interface WxOpenCardService {
   ...
   */
  String getCardApiTicket(String appid, boolean forceRefresh) throws WxErrorException;
   ...
   * @return 解密后的Code
   */
  String decryptCardCode(String appid, String encryptCode) throws WxErrorException;
   ...
   */
  WxMpCardResult queryCardCode(String appid, String cardId, String code, boolean checkConsume)
    throws WxErrorException;
   ...
   */
  String consumeCardCode(String appid, String code) throws WxErrorException;
   ...
   * <br>可用 com.google.gson.JsonParser#parse 等方法直接取JSON串中的errcode等信息。
   */
  String consumeCardCode(String appid, String code, String cardId) throws WxErrorException;
   ...
   */
  void markCardCode(String appid, String code, String cardId, String openId, boolean isMark) throws
    WxErrorException;
   ...
   */
  String getCardDetail(String appid, String cardId) throws WxErrorException;
}
