 ...
 * @version 2017/7/8
 */
public interface WxOpenMemberCardService {
   ...
   */
  String activateMemberCard(String appid, WxMpMemberCardActivatedMessage activatedMessage) throws WxErrorException;
   ...
   * @throws WxErrorException 接口调用失败抛出的异常
   */
  WxMpMemberCardUserInfoResult getUserInfo(String appid, String cardId, String code) throws WxErrorException;
   ...
   * @throws WxErrorException 接口调用失败抛出的异常
   */
  WxMpMemberCardUpdateResult updateUserMemberCard(String appid, WxMpMemberCardUpdateMessage updateUserMessage) throws WxErrorException;
}
