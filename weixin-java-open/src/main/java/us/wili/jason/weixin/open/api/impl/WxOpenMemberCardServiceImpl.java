...
import us.wili.jason.weixin.open.api.WxOpenMemberCardService;
 ...
 * @version 2017/7/8
 */
public class WxOpenMemberCardServiceImpl implements WxOpenMemberCardService {

  private final Logger log = LoggerFactory.getLogger(WxOpenMemberCardServiceImpl.class);
  ...
  public WxOpenMemberCardServiceImpl(WxOpenService wxOpenService) {
   ...
   */
  @Override
  public String activateMemberCard(String appid, WxMpMemberCardActivatedMessage activatedMessage) throws WxErrorException {
    return this.wxOpenService.post(appid, MEMBER_CARD_ACTIVATE, GSON.toJson(activatedMessage));
  }
   ...
   */
  @Override
  public WxMpMemberCardUserInfoResult getUserInfo(String appid, String cardId, String code) throws WxErrorException {
    JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("card_id", cardId);
    jsonObject.addProperty("code",code);

    String responseContent = this.wxOpenService.post(appid, MEMBER_CARD_USER_INFO_GET, jsonObject.toString());
   ...
   */
  @Override
  public WxMpMemberCardUpdateResult updateUserMemberCard(String appid, WxMpMemberCardUpdateMessage updateUserMessage)
    throws WxErrorException {

    String responseContent = this.wxOpenService.post(appid, MEMBER_CARD_UPDATE_USER, GSON.toJson(updateUserMessage));
