...
public interface WxOpenTemplateMsgService {
   ...
   * @return 是否成功
   */
  boolean setIndustry(String appid, WxMpTemplateIndustry wxMpIndustry) throws WxErrorException;
   ...
   * @return wxMpIndustry
   */
  WxMpTemplateIndustry getIndustry(String appid) throws WxErrorException;
   ...
   * @return 消息Id
   */
  String sendTemplateMsg(String appid, WxMpTemplateMessage templateMessage) throws WxErrorException;
   ...
   */
  String addTemplate(String appid, String shortTemplateId) throws WxErrorException;
   ...
   * @return templateId 模板Id
   */
  List<WxMpTemplate> getAllPrivateTemplate(String appid) throws WxErrorException;
   ...
   */
  boolean delPrivateTemplate(String appid, String templateId) throws WxErrorException;
}
