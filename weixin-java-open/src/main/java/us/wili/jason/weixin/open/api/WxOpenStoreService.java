 ...
 */
public interface WxOpenStoreService<H, P> {
  /**
   * <pre>
   * 创建门店
   * 接口说明
   ...
   * </pre>
   */
  void add(String appid, WxMpStoreBaseInfo request) throws WxErrorException;
   ...
   */
  WxMpStoreBaseInfo get(String appid, String poiId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  void delete(String appid, String poiId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  WxMpStoreListResult list(String appid, int begin, int limit) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  List<WxMpStoreInfo> listAll(String appid) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  void update(String appid, WxMpStoreBaseInfo info) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  List<String> listCategories(String appid) throws WxErrorException;
