...
public interface WxOpenMaterialService {
   ...
   * @see #mediaUpload(String, String, String, InputStream)
   */
  WxMediaUploadResult mediaUpload(String appid, String mediaType, File file) throws WxErrorException;
   ...
   */
  WxMediaUploadResult mediaUpload(String appid, String mediaType, String fileType, InputStream inputStream) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  File mediaDownload(String appid, String mediaId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  WxMediaImgUploadResult mediaImgUpload(String appid, File file) throws WxErrorException;
   ...
   */
  WxMpMaterialUploadResult materialFileUpload(String appid, String mediaType, WxMpMaterial material) throws WxErrorException;
   ...
   */
  WxMpMaterialUploadResult materialNewsUpload(String appid, WxMpMaterialNews news) throws WxErrorException;
   ...
   */
  InputStream materialImageOrVoiceDownload(String appid, String mediaId) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WxMpMaterialVideoInfoResult materialVideoInfo(String appid, String mediaId) throws WxErrorException;
   ...
   */
  boolean materialNewsUpdate(String appid, WxMpMaterialArticleUpdate wxMpMaterialArticleUpdate) throws WxErrorException;
   ...
   */
  WxMpMaterialNewsBatchGetResult materialNewsBatchGet(String appid, int offset, int count) throws WxErrorException;
   ...
   * @param count  返回素材的数量，取值在1到20之间
   */
  WxMpMaterialFileBatchGetResult materialFileBatchGet(String appid, String type, int offset, int count) throws WxErrorException;
