...
public interface WxOpenUserService {
   ...
   * @param remark 备注名
   */
  void userUpdateRemark(String appid, String openid, String remark) throws WxErrorException;
   ...
   * @param openid 用户openid
   */
  WxMpUser userInfo(String appid, String openid) throws WxErrorException;
   ...
   */
  WxMpUser userInfo(String appid, String openid, String lang) throws WxErrorException;
   ...
   */
  List<WxMpUser> userInfoList(String appid, List<String> openids) throws WxErrorException;
   ...
   */
  List<WxMpUser> userInfoList(String appid, WxMpUserQuery userQuery) throws WxErrorException;
   ...
   */
  WxMpUserList userList(String appid, String nextOpenid) throws WxErrorException;
}
