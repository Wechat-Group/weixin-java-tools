...
public class WxCpXmlMessageTest {
  ...
  public void testTemplateCard() {
    ...
    WxCpXmlMessage wxCpXmlMessage = WxCpXmlMessage.fromXml(xml);
    assertEquals(wxCpXmlMessage.getMsgType(), WxConsts.XmlMsgType.EVENT);
    assertEquals(wxCpXmlMessage.getEvent(), WxCpConsts.EventType.TEMPLATE_CARD_EVENT);
    assertEquals(wxCpXmlMessage.getResponseCode(), "ResponseCode");
