...
public interface WxCpTpExternalContactService {
   ...
   */
  @Deprecated
  WxCpExternalContactInfo getExternalContact(String corpId, String userId) throws WxErrorException;
   ...
   */
  WxCpExternalContactInfo getContactDetail(String corpId, String userId) throws WxErrorException;
