package me.chanjar.weixin.qidian.bean.message;
...
import me.chanjar.weixin.qidian.util.crypto.WxMpCryptUtil;
import me.chanjar.weixin.qidian.util.json.WxMpGsonBuilder;
import me.chanjar.weixin.qidian.util.xml.XStreamTransformer;
...
public class WxMpXmlMessage implements Serializable {
   ...
   */
  public static WxMpXmlMessage fromEncryptedXml(String encryptedXml, WxQidianConfigStorage wxMpConfigStorage,
  ...
  public static WxMpXmlMessage fromEncryptedXml(InputStream is, WxQidianConfigStorage wxMpConfigStorage, String timestamp,
